...
OPT_OUT_INSTRUCTIONS = {
    ...
    "google": {
        ...
        "steps": [
            "⚠️ SEARCH ENGINE RESULTS - LIMITED REMOVAL OPTIONS",
            "",
            "Search results show links to OTHER websites - not the search engine's data.",
            "To remove yourself from search results:",
            "",
            "1. Remove the source: Request removal from the original website first",
            "2. Once removed, search engines will update within 1-4 weeks automatically",
            "3. For urgent Google removal: https://support.google.com/websearch/troubleshooter/3111061",
            "",
            "Search engines may remove results containing:",
            "- Personal info like SSN, bank account, credit card numbers",
            "- Explicit images shared without consent",
            "- Doxxing content",
            "",
            "Search engines will NOT remove:",
    ...
    "websearch": {
        ...
        "steps": [
            ...
            "3. For urgent Google removal: https://support.google.com/websearch/troubleshooter/3111061",
            "",
            "Focus on removing your data from the DATA BROKERS listed above first.",
            "Once those are removed, search results will update automatically.",
        ],
        "time": "Remove from source first, then 1-4 weeks",
        "cannot_auto": True,
    },
